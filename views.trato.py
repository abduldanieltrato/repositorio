...
from models import (
    Departamento, Funcionario, Consulta, Paciente, Pagamento,
    ExameMedico, Equipamento, Fatura, Consumivel, Seguradora,
    ProcedimentoMedico, Agendamento, DetalheFuncionario, DetalhePaciente,
    ReceitaMedica, RegistroInternacao, HistoricoConsulta,
    ProcedimentoCirurgico, RegistroVacinacao, TesteLaboratorial,
    AlergiaCondicao, HistoricoPagamento, ContatoEmergencia,
    EspecialidadeMedica
)
